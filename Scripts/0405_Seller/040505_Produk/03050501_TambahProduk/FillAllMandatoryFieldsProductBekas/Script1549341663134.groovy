...
Mobile.setText(findTestObject('0405_Seller/040505_Produk/04050501_TambahProduk/txtBoxNamaProduk'), 'Baju', 
    0)
...
Mobile.setText(findTestObject('0405_Seller/040505_Produk/04050501_TambahProduk/txtBoxDescProduk'), 'Ini Desc', 
    0)

Mobile.tap(findTestObject('btnKeyboardDone'), 0)

Mobile.tap(findTestObject('0405_Seller/040505_Produk/04050501_TambahProduk/rbBekas'), 0)
